...
@PageTitle("Projekte")
@Route(value = "projects/:samplePersonID?/:action?(edit)", layout = MainLayout.class)
@Uses(Icon.class)
public class ProjekteView extends Div implements BeforeEnterObserver {

    private final String SAMPLEPERSON_ID = "samplePersonID";
    private final String SAMPLEPERSON_EDIT_ROUTE_TEMPLATE = "projects/%s/edit";
    ...
    @Autowired
    public ProjekteView(SamplePersonService samplePersonService) {
